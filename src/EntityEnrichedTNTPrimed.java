...
public class EntityEnrichedTNTPrimed extends Entity
{
    public int fuse;

    public EntityEnrichedTNTPrimed(World world)
    {
        super(world);
        this.fuse = 0;
    ...
    public EntityEnrichedTNTPrimed(World par1World, double par2, double par4, double par6)
    {
        this(par1World);
