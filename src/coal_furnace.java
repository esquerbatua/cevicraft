...
public class coal_furnace extends BlockContainer
{
    ...
    public boolean onBlockActivated(World par1World, int x, int y, int z, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityCoalFurnace blockEntity = (TileEntityCoalFurnace)par1World.getBlockTileEntity(x, y, z);

            if (blockEntity != null)
            {
            	if(blockEntity instanceof TileEntityCoalFurnace)
            	{
	            	TileEntityCoalFurnace var6 = (TileEntityCoalFurnace)par1World.getBlockTileEntity(x, y, z);
